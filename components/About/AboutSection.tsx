...
import TechChips from "components/About/TechChips";
...
interface AppProps extends AboutSectionMetaStructure {
  index: number;
}
...
function AboutSection({
  ...
  if (odd) {
    return (
      <Wave color={darkMode ? colorDark : colorLight}>{renderAboutSection()}</Wave>
    );
  }
