              ...
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  <Link
                    ...
                    href="https://github.com/anshulgammy"
                    target="_blank"
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://www.linkedin.com/in/anshulgammy/"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://twitter.com/anshulgammy"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="mailto:anshulgammy@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                    <MailIcon fontSize="large" className={classes.icon} />
                    <Typography>anshulgammy@gmail.com</Typography>
                  </Link>
                </Grid>
